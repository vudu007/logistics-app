...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'a-fallback-secret-key-for-local-only')

# --- DATABASE CONFIGURATION (Hybrid: Cloud PostgreSQL OR Local SQLite) ---
BASE_DIR = os.path.abspath(os.path.dirname(__file__))

# Check for Render Database URL (PostgreSQL)
